        ...
        <div className="flex flex-col md:flex-row gap-y-4 justify-between items-center border-t border-gray-100 mt-6 py-6">
          <div className="text-xs text-gray-700 flex gap-x-8">
            ...
            <a href="#" className="text-primary-brand-color hover:underline 
                relative before:w-[3px] before:h-[3px] before:bg-black before:absolute before:-left-4 before:top-1/2 before:-translate-y-1/2 before:rounded-full">
          ...
          <nav className="flex gap-x-3">
            ...
            <a href="#" className="h-8  flex items-center px-2 text-sm gap-x-2 border border-gray-100 rounded text-gray-500 hover:border-transparent hover:bg-primary-brand-color hover:bg-opacity-10 hover:text-primary-brand-color transition-colors">
              <BiGlobe size={18} />
              Türkçe (TR)
            </a>
          </nav>
