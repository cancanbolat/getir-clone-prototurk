export default function MobileApp() {
  return (
    <div className="bg-primary-brand-color bg-mobile-app flex flex-col md:flex-row 
      justify-between items-center md:rounded-lg text-white">
      <div className="flex flex-col gay-y-3 p-10 text-center md:text-left">
